...
{sizes.map((size,index) => (
 ...
 <div className='profilecard'>
    ...
    <div className='sproductcontainer'>
      <div className='leftdivsp'>   <img src={producttt.img}></img></div>
   <div className='rightdivsp'>
    <div className='righttext'>
    <h1 style={{fontSize: '16px'}}>{producttt.title} - ({producttt.color}) <span style={{ fontSize: '15px' }}>{producttt.reviews}</span> <br />
   <span style={{ textDecoration: 'line-through' ,fontSize: '12px'}}>{producttt.prevPrice}</span> <br />
   <span style={{ fontSize: '12px' }}>${producttt.newPrice}</span><br />
   <span style={{ fontSize: '12px' }}> company: {producttt.company} </span><br />
   <span style={{ fontSize: '12px' }}> category: {producttt.category} </span><br />
   </h1>
   <div className='rightbuttons'>

   <select placeholder id='addtocartbtn' value='selectedsize' className='categorypageaddtocartbtn'onChange={(e)=> {getItems();addproducttoccart(producttt ,e.target.value)}} >
...
{sizes.map((size,index) => (
 ...
 <div className='bestsp'>
   <p>
  <b> Articles from the same company </b><br />
 ...
 <img src={item.img} alt='sandalsbanner' onClick={() => {filtercompanyselelrcount();}}></img></Link>
 </div>
